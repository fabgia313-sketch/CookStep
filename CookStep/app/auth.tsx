...
export default function AuthScreen() {
  ...
  const handleSubmit = async () => {
    ...
    if (!email.trim()) {
      setLocalError('Saisis ton adresse email.');
      return;
    }
  ...
  const handleGoogle = async () => {
    ...
    try {
      ...
      // Session update is handled by the auth state listener in _layout
    } catch {
        ...
        >
          ...
          >
            ...
            <View style={styles.form}>
              ...
              {/* Submit button */}
              <Pressable
                style={({ pressed }) => [styles.submitButton, pressed && { opacity: 0.88 }, loading && styles.submitButtonDisabled]}
